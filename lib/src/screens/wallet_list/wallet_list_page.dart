...
class WalletListBodyState extends State<WalletListBody> {
  ...
  void _onSuccessfulAuth(WalletListItem wallet) async {
    ...
    await showPopUp<void>(
        ...
        builder: (BuildContext context) {
          return AlertWithTwoActions(
            ...
            alertContent:
                S.of(context).delete_wallet_confirm_message(wallet.name),
            leftButtonText: S.of(context).cancel,
    ...
    if (confirmed) {
      try {
        widget.walletListViewModel.changeProcessText(
            S.of(context).wallet_list_removing_wallet(wallet.name), context);
        await widget.walletListViewModel.remove(wallet);
        widget.walletListViewModel.hideProgressText();
      } catch (e) {
        widget.walletListViewModel.changeProcessText(
